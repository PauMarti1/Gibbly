...
def PartSord():
     pass
# Comença hand tracking
# Passem de signe a lletra (Image to text)
# De lletra a parlada (Text to speech)
# Quan hi ha 3 espais seguits al text ("15 segons sense mans") passem a part parl (PartParl())
def PartParl():
     pass
# Comença escoltant (Speech to text)
# Transcriu a ASL (Text to image)
# Mostra per pantalla els signes
# TPassem a part sord (PartSord())
